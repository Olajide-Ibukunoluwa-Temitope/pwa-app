  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen font-dmsans">
      ...
      <div className='w-full h-full flex flex-col md:flex-row'>
        <div className='w-full md:w-1/2 h-full bg-pink-400 hover:bg-yellow-400 flex justify-center items-center cursor-pointer'>
          <Link href='/login'>
            <p className='text-5xl h-full w-full flex justify-center items-center text-white'>Login</p>
          </Link>
        </div>
        <div className='w-full md:w-1/2 h-full bg-red-400 hover:bg-yellow-400 flex justify-center items-center cursor-pointer'>
